// Scan for servers that can be hacked
// Do not scan beyond a server that cannot be hacked
// Run the gainAccess.js script to hack the server
...
//		ns.tprint(target + " --> " + connected);
	...
	ns.tprint("Scanned: " + scanned);
	ns.tprint("To Hack: " + tohack);

	ns.spawn("/simple/gainAccess.js", 1, tohack);
